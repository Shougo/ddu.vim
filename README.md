...
**NOTE:** For the exact compatibility and requirements, see the COMPATIBILITY
section in the documentation: `doc/ddu.txt`.

### Requirements

Please install both Deno 2.3.0+ and denops.vim v8.0+ (see `doc/ddu.txt` for
